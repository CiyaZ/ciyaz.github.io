...
Webpack是一个web前端构建工具，类似Java的Maven，主要应用于现代的模块化前端开发项目，Webpack支持灵活的扩展配置，而且生态非常丰富，但缺点是使用比较复杂，目前许多框架的“脚手架”都是基于Webpack封装而成的。

本篇笔记以最新的Webpack4为例，结合当前最流行的yarn包管理工具，介绍webpack的简单使用。
